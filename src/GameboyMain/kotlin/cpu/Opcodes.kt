...
class Opcodes {
    ...
    init {
        ...
        op[0x0B] = Opcode("DEC BC", 1, 8) {cpu: Cpu -> }
        op[0x0C] = Opcode("INC C", 1, 4) {cpu: Cpu -> }
        op[0x0D] = Opcode("DEC C", 1, 4) {cpu: Cpu -> }
        op[0x0E] = Opcode("LD C,u8", 2, 8) {cpu: Cpu -> }
        op[0x0F] = Opcode("RRCA", 1, 4) {cpu: Cpu -> }

        op[0x10] = Opcode("STOP", 2, 4) {cpu: Cpu -> }
        op[0x11] = Opcode("LD DE,u16", 3, 12) {cpu: Cpu -> }
        op[0x12] = Opcode("LD (DE),A", 1, 8) {cpu: Cpu -> }
        op[0x13] = Opcode("INC DE", 1, 8) {cpu: Cpu -> }
        op[0x14] = Opcode("INC D", 1, 4) {cpu: Cpu -> }
        op[0x15] = Opcode("DEC D", 1, 4) {cpu: Cpu -> }
        ...
        op[0x1B] = Opcode("DEC DE", 1, 8) {cpu: Cpu -> }
        op[0x1C] = Opcode("INC E", 1, 4) {cpu: Cpu -> }
        op[0x1D] = Opcode("DEC E", 1, 4) {cpu: Cpu -> }
        op[0x1E] = Opcode("LD E,u8", 2, 8) {cpu: Cpu -> }
        op[0x1F] = Opcode("RRA", 1, 4) {cpu: Cpu -> }

        op[0x20] = Opcode("JR NZ,i8", 2, 12) {cpu: Cpu -> }
        op[0x21] = Opcode("LD HL,u16", 3, 12) {cpu: Cpu -> }
        op[0x22] = Opcode("LD (HL+),A", 1, 8) {cpu: Cpu -> }
        op[0x23] = Opcode("INC HL", 1, 8) {cpu: Cpu -> }
        op[0x24] = Opcode("INC H", 1, 4) {cpu: Cpu -> }
        op[0x25] = Opcode("DEC H", 1, 4) {cpu: Cpu -> }
        ...
        op[0x2B] = Opcode("DEC HL", 1, 8) {cpu: Cpu -> }
        op[0x2C] = Opcode("INC L", 1, 4) {cpu: Cpu -> }
        op[0x2D] = Opcode("DEC L", 1, 4) {cpu: Cpu -> }
        op[0x2E] = Opcode("LD L,u8", 2, 8) {cpu: Cpu -> }
        op[0x2F] = Opcode("CPL", 1, 4) {cpu: Cpu -> }

        op[0x30] = Opcode("JR NC,i8", 2, 12) {cpu: Cpu -> }
        op[0x31] = Opcode("LD SP,u16", 3, 12) {cpu: Cpu -> }
        op[0x32] = Opcode("LD (HL-),A", 1, 8) {cpu: Cpu -> }
        op[0x33] = Opcode("INC SP", 1, 8) {cpu: Cpu -> }
        ...
        op[0x3B] = Opcode("DEC SP", 1, 8) {cpu: Cpu -> }
        op[0x3C] = Opcode("INC A", 1, 4) {cpu: Cpu -> }
        op[0x3D] = Opcode("DEC A", 1, 4) {cpu: Cpu -> }
        op[0x3E] = Opcode("LD A,u8", 2, 8) {cpu: Cpu -> }
        op[0x3F] = Opcode("CCF", 1, 4) {cpu: Cpu -> }

        op[0x40] = Opcode("LD B,B", 1, 4) {cpu: Cpu -> }
        op[0x41] = Opcode("LD B,C", 1, 4) {cpu: Cpu -> }
        op[0x42] = Opcode("LD B,D", 1, 4) {cpu: Cpu -> }
        op[0x43] = Opcode("LD B,E", 1, 4) {cpu: Cpu -> }
        op[0x44] = Opcode("LD B,H", 1, 4) {cpu: Cpu -> }
        op[0x45] = Opcode("LD B,L", 1, 4) {cpu: Cpu -> }
        op[0x46] = Opcode("LD B,(HL)", 1, 8) {cpu: Cpu -> }
        op[0x47] = Opcode("LD B,A", 1, 4) {cpu: Cpu -> }
        op[0x48] = Opcode("LD C,B", 1, 4) {cpu: Cpu -> }
        op[0x49] = Opcode("LD C,C", 1, 4) {cpu: Cpu -> }
        op[0x4A] = Opcode("LD C,D", 1, 4) {cpu: Cpu -> }
        op[0x4B] = Opcode("LD C,E", 1, 4) {cpu: Cpu -> }
        op[0x4C] = Opcode("LD C,H", 1, 4) {cpu: Cpu -> }
        op[0x4D] = Opcode("LD C,L", 1, 4) {cpu: Cpu -> }
        op[0x4E] = Opcode("LD C,(HL)", 1, 8) {cpu: Cpu -> }
        op[0x4F] = Opcode("LD C,A", 1, 4) {cpu: Cpu -> }

        op[0x50] = Opcode("LD D,B", 1, 4) {cpu: Cpu -> }
        op[0x51] = Opcode("LD D,C", 1, 4) {cpu: Cpu -> }
        op[0x52] = Opcode("LD D,D", 1, 4) {cpu: Cpu -> }
        op[0x53] = Opcode("LD D,E", 1, 4) {cpu: Cpu -> }
        op[0x54] = Opcode("LD D,H", 1, 4) {cpu: Cpu -> }
        op[0x55] = Opcode("LD D,L", 1, 4) {cpu: Cpu -> }
        op[0x56] = Opcode("LD D,(HL)", 1, 8) {cpu: Cpu -> }
        op[0x57] = Opcode("LD D,A", 1, 4) {cpu: Cpu -> }
        op[0x58] = Opcode("LD E,B", 1, 4) {cpu: Cpu -> }
        op[0x59] = Opcode("LD E,C", 1, 4) {cpu: Cpu -> }
        op[0x5A] = Opcode("LD E,D", 1, 4) {cpu: Cpu -> }
        op[0x5B] = Opcode("LD E,E", 1, 4) {cpu: Cpu -> }
        op[0x5C] = Opcode("LD E,H", 1, 4) {cpu: Cpu -> }
        op[0x5D] = Opcode("LD E,L", 1, 4) {cpu: Cpu -> }
        op[0x5E] = Opcode("LD E,(HL)", 1, 8) {cpu: Cpu -> }
        op[0x5F] = Opcode("LD E,A", 1, 4) {cpu: Cpu -> }

        op[0x60] = Opcode("LD H,B", 1, 4) {cpu: Cpu -> }
        op[0x61] = Opcode("LD H,C", 1, 4) {cpu: Cpu -> }
        op[0x62] = Opcode("LD H,D", 1, 4) {cpu: Cpu -> }
        op[0x63] = Opcode("LD H,E", 1, 4) {cpu: Cpu -> }
        op[0x64] = Opcode("LD H,H", 1, 4) {cpu: Cpu -> }
        op[0x65] = Opcode("LD H,L", 1, 4) {cpu: Cpu -> }
        op[0x66] = Opcode("LD H,(HL)", 1, 8) {cpu: Cpu -> }
        op[0x67] = Opcode("LD H,A", 1, 4) {cpu: Cpu -> }
        op[0x68] = Opcode("LD L,B", 1, 4) {cpu: Cpu -> }
        op[0x69] = Opcode("LD L,C", 1, 4) {cpu: Cpu -> }
        op[0x6A] = Opcode("LD L,D", 1, 4) {cpu: Cpu -> }
        op[0x6B] = Opcode("LD L,E", 1, 4) {cpu: Cpu -> }
        op[0x6C] = Opcode("LD L,H", 1, 4) {cpu: Cpu -> }
        op[0x6D] = Opcode("LD L,L", 1, 4) {cpu: Cpu -> }
        op[0x6E] = Opcode("LD L,(HL)", 1, 8) {cpu: Cpu -> }
        op[0x6F] = Opcode("LD L,A", 1, 4) {cpu: Cpu -> }
        ...
        op[0x78] = Opcode("LD A,B", 1, 4) {cpu: Cpu -> }
        op[0x79] = Opcode("LD A,C", 1, 4) {cpu: Cpu -> }
        op[0x7A] = Opcode("LD A,D", 1, 4) {cpu: Cpu -> }
        op[0x7B] = Opcode("LD A,E", 1, 4) {cpu: Cpu -> }
        op[0x7C] = Opcode("LD A,H", 1, 4) {cpu: Cpu -> }
        op[0x7D] = Opcode("LD A,L", 1, 4) {cpu: Cpu -> }
        op[0x7E] = Opcode("LD A,(HL)", 1, 8) {cpu: Cpu -> }
        op[0x7F] = Opcode("LD A,A", 1, 4) {cpu: Cpu -> }

        op[0x80] = Opcode("ADD A,B", 1, 4) {cpu: Cpu -> }
        op[0x81] = Opcode("ADD A,C", 1, 4) {cpu: Cpu -> }
        op[0x82] = Opcode("ADD A,D", 1, 4) {cpu: Cpu -> }
        op[0x83] = Opcode("ADD A,E", 1, 4) {cpu: Cpu -> }
        op[0x84] = Opcode("ADD A,H", 1, 4) {cpu: Cpu -> }
        op[0x85] = Opcode("ADD A,L", 1, 4) {cpu: Cpu -> }
        op[0x86] = Opcode("ADD A,(HL)", 1, 8) {cpu: Cpu -> }
        op[0x87] = Opcode("ADD A,A", 1, 4) {cpu: Cpu -> }
        op[0x88] = Opcode("ADC A,B", 1, 4) {cpu: Cpu -> }
        op[0x89] = Opcode("ADC A,C", 1, 4) {cpu: Cpu -> }
        op[0x8A] = Opcode("ADC A,D", 1, 4) {cpu: Cpu -> }
        op[0x8B] = Opcode("ADC A,E", 1, 4) {cpu: Cpu -> }
        op[0x8C] = Opcode("ADC A,H", 1, 4) {cpu: Cpu -> }
        op[0x8D] = Opcode("ADC A,L", 1, 4) {cpu: Cpu -> }
        op[0x8E] = Opcode("ADC A,(HL)", 1, 8) {cpu: Cpu -> }
        op[0x8F] = Opcode("ADC A,A", 1, 4) {cpu: Cpu -> }
        ...
        op[0x9B] = Opcode("SBC A,E", 1, 4) {cpu: Cpu -> }
        op[0x9C] = Opcode("SBC A,H", 1, 4) {cpu: Cpu -> }
        op[0x9D] = Opcode("SBC A,L", 1, 4) {cpu: Cpu -> }
        op[0x9E] = Opcode("SBC A,(HL)", 1, 8) {cpu: Cpu -> }
        op[0x9F] = Opcode("SBC A,A", 1, 4) {cpu: Cpu -> }
