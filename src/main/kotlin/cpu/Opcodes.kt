...
class Opcodes {
    ...
    companion object {
        ...
        fun opcodes(): ArrayList<Opcode> {
            ...
            op[0xA] = Opcode("LD A,(BC)", 1, 8) { cpu: Cpu -> cpu.ld_r8_r16(Register.A, Register.BC) }
            ...
            op[0x10] = Opcode("STOP", 2, 4) { cpu: Cpu -> cpu.stop() }
            ...
            op[0x17] = Opcode("RLA", 1, 4) { cpu: Cpu -> cpu.rl(Register.A) }
            op[0x18] = Opcode("JR i8", 2, 12) { cpu: Cpu -> cpu.jr(Condition.TRUE) }
            op[0x19] = Opcode("ADD HL,DE", 1, 8) { cpu: Cpu -> cpu.add_hl_r16(Register.DE) }
            op[0x1A] = Opcode("LD A,(DE)", 1, 8) { cpu: Cpu -> cpu.ld_r8_r16(Register.A, Register.DE) }
            ...
            op[0x1F] = Opcode("RRA", 1, 4) { cpu: Cpu -> cpu.rr(Register.A) }
            ...
            op[0x27] = Opcode("DAA", 1, 4) { cpu: Cpu -> cpu.daa() }
            op[0x28] = Opcode("JR Z,i8", 2, 12) { cpu: Cpu -> cpu.jr(Condition.Z) }
            op[0x29] = Opcode("ADD HL,HL", 1, 8) { cpu: Cpu -> cpu.add_hl_r16(Register.HL) }
            op[0x2A] = Opcode("LD A,(HL+)", 1, 8) { cpu: Cpu -> cpu.ld_r8_r16(Register.A, Register.HL) }
            ...
            op[0x2F] = Opcode("CPL", 1, 4) { cpu: Cpu -> cpu.cpl(Register.A) }
            ...
            op[0x36] = Opcode("LD (HL),u8", 2, 12) { cpu: Cpu -> cpu.ld_r8_u8(Register.HL) }
            op[0x37] = Opcode("SCF", 1, 4) { cpu: Cpu -> cpu.scf() }
            op[0x38] = Opcode("JR C,i8", 2, 12) { cpu: Cpu -> cpu.jr(Condition.C) }
            op[0x39] = Opcode("ADD HL,SP", 1, 8) { cpu: Cpu -> cpu.add_hl_r16(Register.SP) }
            op[0x3A] = Opcode("LD A,(HL-)", 1, 8) { cpu: Cpu -> cpu.ld_r8_r16(Register.A, Register.SP) }
            ...
            op[0x3F] = Opcode("CCF", 1, 4) { cpu: Cpu -> cpu.ccf() }
            ...
            op[0x46] = Opcode("LD B,(HL)", 1, 8) { cpu: Cpu -> cpu.ld_r8_r8(Register.B, Register.HL) }
            ...
            op[0x4E] = Opcode("LD C,(HL)", 1, 8) { cpu: Cpu -> cpu.ld_r8_r8(Register.C, Register.HL) }
            ...
            op[0x56] = Opcode("LD D,(HL)", 1, 8) { cpu: Cpu -> cpu.ld_r8_r8(Register.D, Register.HL) }
            ...
            op[0x5E] = Opcode("LD E,(HL)", 1, 8) { cpu: Cpu -> cpu.ld_r8_r8(Register.E, Register.HL) }
            ...
            op[0x66] = Opcode("LD H,(HL)", 1, 8) { cpu: Cpu -> cpu.ld_r8_r8(Register.H, Register.HL) }
            ...
            op[0x6E] = Opcode("LD L,(HL)", 1, 8) { cpu: Cpu -> cpu.ld_r8_r8(Register.L, Register.HL) }
            ...
            op[0x76] = Opcode("HALT", 1, 4) { cpu: Cpu -> cpu.halt() }
            ...
            op[0x7E] = Opcode("LD A,(HL)", 1, 8) { cpu: Cpu -> cpu.ld_r8_r16(Register.A, Register.HL) }
            ...
            op[0x86] = Opcode("ADD A,(HL)", 1, 8) { cpu: Cpu -> cpu.add_a_r8(Register.HL) }
            ...
            op[0x8E] = Opcode("ADC A,(HL)", 1, 8) { cpu: Cpu -> cpu.addc_a_r8(Register.HL) }
            ...
            op[0x96] = Opcode("SUB A,(HL)", 1, 8) { cpu: Cpu -> cpu.sub_a_r8(Register.HL) }
            ...
            op[0x9E] = Opcode("SBC A,(HL)", 1, 8) { cpu: Cpu -> cpu.subc_a_r8(Register.HL) }
            ...
            op[0xA6] = Opcode("AND A,(HL)", 1, 8) { cpu: Cpu -> cpu.and_a_r8(Register.HL) }
            op[0xA7] = Opcode("AND A,A", 1, 4) { cpu: Cpu -> cpu.and_a_r8(Register.A) }
            op[0xA8] = Opcode("XOR A,B", 1, 4) { cpu: Cpu -> cpu.xor_a_r8(Register.B) }
            op[0xA9] = Opcode("XOR A,C", 1, 4) { cpu: Cpu -> cpu.xor_a_r8(Register.C) }
            op[0xAA] = Opcode("XOR A,D", 1, 4) { cpu: Cpu -> cpu.xor_a_r8(Register.D) }
            op[0xAB] = Opcode("XOR A,E", 1, 4) { cpu: Cpu -> cpu.xor_a_r8(Register.E) }
            op[0xAC] = Opcode("XOR A,H", 1, 4) { cpu: Cpu -> cpu.xor_a_r8(Register.H) }
            op[0xAD] = Opcode("XOR A,L", 1, 4) { cpu: Cpu -> cpu.xor_a_r8(Register.L) }
            op[0xAE] = Opcode("XOR A,(HL)", 1, 8) { cpu: Cpu -> cpu.xor_a_r8(Register.HL) }
            ...
            op[0xB6] = Opcode("OR A,(HL)", 1, 8) { cpu: Cpu -> cpu.or_a_r8(Register.HL) }
            op[0xB7] = Opcode("OR A,A", 1, 4) { cpu: Cpu -> cpu.or_a_r8(Register.A) }
            op[0xB8] = Opcode("CP A,B", 1, 4) { cpu: Cpu -> cpu.cp_a_r8(Register.B) }
            op[0xB9] = Opcode("CP A,C", 1, 4) { cpu: Cpu -> cpu.cp_a_r8(Register.C) }
            op[0xBA] = Opcode("CP A,D", 1, 4) { cpu: Cpu -> cpu.cp_a_r8(Register.D) }
            op[0xBB] = Opcode("CP A,E", 1, 4) { cpu: Cpu -> cpu.cp_a_r8(Register.E) }
            op[0xBC] = Opcode("CP A,H", 1, 4) { cpu: Cpu -> cpu.cp_a_r8(Register.H) }
            op[0xBD] = Opcode("CP A,L", 1, 4) { cpu: Cpu -> cpu.cp_a_r8(Register.L) }
            ...
            op[0xC1] = Opcode("POP BC", 1, 12) { cpu: Cpu -> cpu.pop(Register.BC) }
            ...
            op[0xC7] = Opcode("RST 00h", 1, 16) { cpu: Cpu -> cpu.rst(0x0u) }
            ...
            op[0xCF] = Opcode("RST 08h", 1, 16) { cpu: Cpu -> cpu.rst(0x08u) }

            op[0xD0] = Opcode("RET NC", 1, 20) { cpu: Cpu -> cpu.retc(Condition.NC) }
            op[0xD1] = Opcode("POP DE", 1, 12) { cpu: Cpu -> cpu.pop(Register.DE) }
            ...
            op[0xD7] = Opcode("RST 10h", 1, 16) { cpu: Cpu -> cpu.rst(0x10u) }
            ...
            op[0xDE] = Opcode("SBC A,u8", 2, 8) { cpu: Cpu -> cpu.subc_a_r8(Register.u8) }
            op[0xDF] = Opcode("RST 18h", 1, 16) { cpu: Cpu -> cpu.rst(0x18u) }

            op[0xE0] = Opcode("LD (FF00+u8),A", 2, 12) { cpu: Cpu -> cpu.ldh_u8_r8(Register.A) }
            op[0xE1] = Opcode("POP HL", 1, 12) { cpu: Cpu -> cpu.pop(Register.HL) }
            op[0xE2] = Opcode("LD (FF00+C),A", 1, 8) { cpu: Cpu -> cpu.ldh_c_r8(Register.A) }
            ...
            op[0xEE] = Opcode("XOR A,u8", 2, 8) { cpu: Cpu -> cpu.xor_a_r8(Register.u8) }
            op[0xEF] = Opcode("RST 28h", 1, 16) { cpu: Cpu -> cpu.rst(0x28u) }
            ...
            op[0xF7] = Opcode("RST 30h", 1, 16) { cpu: Cpu -> cpu.rst(0x30u) }
            op[0xF8] = Opcode("LD HL,SP+i8", 2, 12) { cpu: Cpu -> cpu.ld_hl_sp() }
            op[0xF9] = Opcode("LD SP,HL", 1, 8) { cpu: Cpu -> cpu.ld_sp_hl() }
            op[0xFA] = Opcode("LD A,(u16)", 3, 16) { cpu: Cpu -> cpu.ld_r8_u16(Register.A) }
            ...
            op[0xFF] = Opcode("RST 38h", 1, 16) { cpu: Cpu -> cpu.rst(0x38u) }
            return op
        }
    }
